...
<head>
 ...
 <link rel="stylesheet" type="text/css" href="styleplayerhistory.css">
</head>
<body>
  <header>
      <div class="row">
          <ul class="main-nav">
             ...
             <li class="active"><a href="http://localhost//DBMSMiniProject/playerhistory.php"> PLAYER HISTORY </a></li>
   ...
   <div class="loginbox">
      ...
      <form method="POST" action="historyDetails.php">
          <p>Player ID</p>
